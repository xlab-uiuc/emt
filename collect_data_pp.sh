...
image_path=(
    $(realpath "image_record_loading.ext4_rep0")
    $(realpath "image_record_loading.ext4_rep1")
    $(realpath "image_record_loading.ext4_rep2")
    $(realpath "image_record_loading.ext4_rep3")
)
